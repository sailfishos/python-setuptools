...
Patch1:         0001-Simplify-egg_info-tag-to-make-build-reproducible.patch
...
# You can generate the list with gen_bundled_provides.sh
...
Provides: bundled(python3dist(wheel)) = 0.43.0
